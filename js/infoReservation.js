...
class Reservation {
    constructor() {
        ...
        this.textemin = document.getElementById("color");
        this.textsec = document.getElementById("colors");
    ...
    reserva(){// on stock les information de visiteur dans localstorage/sessionstorage.
         ...
         this.boutonConfirmerResa.addEventListener('click', function(){
            ...
            this.textemin.classList.remove("invisible");
            this.textsec.classList.remove("invisible");
        ...
        chronometre() { // Methode pour le chronometre       
            ...
            this.chrono = setInterval( () =>{ // On lance ce maudit chrono !
                    ...
                    if (this.minutes == 0 && this.secondes == 55 ) {
                        ...
                        this.textsec.classList.add("invisible");
                        this.textemin.classList.add("invisible");
